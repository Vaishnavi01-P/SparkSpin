...
Multiple categories for each generator:

Jokes: Funny, Dad Jokes, Programming, Puns, etc.

Stories: Fantasy, Sci-Fi, Adventure, Mystery, Slice of Life, etc.

Quotes: Motivational, Funny, Aesthetic.

Compliments: Cute, Fun, Motivational.
...
Click Generate to display content.
...
Tabbed navigation for easy switching between generators.

Scrollable output for long content like stories and jokes.
